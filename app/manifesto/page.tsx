    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-32 pb-20 px-6 max-w-4xl mx-auto">
        <article className="prose prose-lg dark:prose-invert max-w-none">
          ...
          >
            <span className="text-xs font-mono text-muted-foreground mb-4 block uppercase tracking-widest">
              The Mission
            </span>
          ...
          <div className="space-y-12 text-xl md:text-2xl font-light leading-relaxed text-muted-foreground">
            ...
            <p>
              We built GitProof because we were tired of being judged by keywords
              rather than key contributions. We believe that your GitHub activity
              is the single most potent signal of your capability—but only if it
              can be translated into a language that recruiters speak.
            </p>
